...
public class StaleElementWithFindElements {
	...
	public static void main(String[] args) {
		...
		for (int i=0; i<footerList.size(); i++) {
			...
			footerList = driver.findElements(By.cssSelector("footer a"));   //re-initializing to avoid StaleElementRefException
		}
		
		
		// for each loop does not work properly in case of refresh/back/forward
